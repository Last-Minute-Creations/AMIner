...
static tHiScore s_pPrevScores[SCORE_MODE_COUNT][SCORE_COUNT] = {
	...
	{
		{.lScore = 10000, .szName = "D_First"},
		{.lScore = 9000,  .szName = "D_Second"},
		{.lScore = 8000,  .szName = "D_Third"},
		{.lScore = 7000,  .szName = "D_4th"},
		{.lScore = 6000,  .szName = "D_5th"},
		{.lScore = 5000,  .szName = "D_6th"},
		{.lScore = 4000,  .szName = "D_7th"},
		{.lScore = 3000,  .szName = "D_8th"},
		{.lScore = 2000,  .szName = "D_9th"},
		{.lScore = 1000,  .szName = "D_10th"},
	},
};
