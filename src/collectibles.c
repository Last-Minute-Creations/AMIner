...
static const tCollectiblesZoneDef s_pZones[COLLECTIBLE_KIND_COUNT] = {
	...
	[COLLECTIBLE_KIND_GATE] = {
		...
		.pBobCoords = {
			{.uwX = 32 +  73, .uwY = 209 * TILE_SIZE + 217},
			{.uwX = 32 +  90, .uwY = 209 * TILE_SIZE + 210},
			{.uwX = 32 +  97, .uwY = 209 * TILE_SIZE + 198},
			{.uwX = 32 + 104, .uwY = 209 * TILE_SIZE + 186},
			{.uwX = 32 + 103, .uwY = 209 * TILE_SIZE + 168},
			{.uwX = 32 +  97, .uwY = 209 * TILE_SIZE + 154},
			{.uwX = 32 +  87, .uwY = 209 * TILE_SIZE + 144},
			{.uwX = 32 +  72, .uwY = 209 * TILE_SIZE + 141},
			{.uwX = 32 +  56, .uwY = 209 * TILE_SIZE + 141},
			{.uwX = 32 +  42, .uwY = 209 * TILE_SIZE + 144},
			{.uwX = 32 +  32, .uwY = 209 * TILE_SIZE + 153},
			{.uwX = 32 +  27, .uwY = 209 * TILE_SIZE + 167},
			{.uwX = 32 +  27, .uwY = 209 * TILE_SIZE + 185},
			{.uwX = 32 +  31, .uwY = 209 * TILE_SIZE + 198},
			{.uwX = 32 +  40, .uwY = 209 * TILE_SIZE + 210},
			{.uwX = 32 +  57, .uwY = 209 * TILE_SIZE + 216},
		},
		.pBobSizes = {
			{.uwX = 32, .uwY = 10},
			{.uwX = 32, .uwY = 17},
