...
#define TILE_ROW_CHALLENGE_CHECKPOINT_2 (TILE_ROW_CHALLENGE_CHECKPOINT_1 + 20)
#define TILE_ROW_CHALLENGE_CHECKPOINT_3 (TILE_ROW_CHALLENGE_CHECKPOINT_2 + 15)
#define TILE_ROW_CHALLENGE_FINISH (TILE_ROW_CHALLENGE_CHECKPOINT_3 + 10)
